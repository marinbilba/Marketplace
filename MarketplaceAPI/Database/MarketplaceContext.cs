    ...
    { 
      ...
      public DbSet<CustomerOrder> CustomerOrder { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Category>().HasData(new Category(){Id = 2,Name = "Toys"});
            
            modelBuilder.Entity<Product>().HasData(new Product(){Id = 1,Name = "ACER G502",Description = "Lorem",Price = 350,ThumbnailUrl = "https://res.cloudinary.com/dxfq3iotg/image/upload/v1571750967/Ecommerce/ef192a21ec96.jpg",Stock = 19,CategoryId = 1});
